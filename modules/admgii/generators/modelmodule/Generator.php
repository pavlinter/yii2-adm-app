...
namespace app\modules\admgii\generators\modelmodule;
...
class Generator extends \app\modules\admgii\Generator
{
    ...
    public $tableName;
    public $modelClass = 'app\modules\{moduleID}\models';
    ...
    public function rules()
    {
        return array_merge(parent::rules(), [
            [['db', 'ns', 'tableName', 'modelClass', 'baseClass', 'moduleClass', 'moduleID'], 'filter', 'filter' => 'trim'],
