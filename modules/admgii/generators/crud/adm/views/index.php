            ...
            [
                ...
                'buttons' => [
                    'copy' => function ($url, $model, $key) {
                        $url = Url::current(['create', 'copy_id' => $model->id<?= $generator->ifParent(", 'id_parent' => \$model->" . $generator->getParentColumn() . " ? \$model->" . $generator->getParentColumn() . " : 0") ?>]);
                    ...
                    'files' => function ($url, $model, $key) {
                        $url = Url::current(['files', 'id' => $model->id<?= $generator->ifParent(", 'id_parent' => \$model->" . $generator->getParentColumn() . " ? \$model->" . $generator->getParentColumn() . " : 0") ?>]);
...
<?php if ($generator->getParentColumn()) {?>
                    ...
                    'update' => function ($url, $model, $key) {
                        $url = Url::current(['update', 'id' => $model->id<?= $generator->ifParent(", 'id_parent' => \$model->" . $generator->getParentColumn() . " ? \$model->" . $generator->getParentColumn() . " : 0") ?>]);
                    ...
                    'delete' => function ($url, $model, $key) {
                        $url = Url::current(['delete', 'id' => $model->id<?= $generator->ifParent(", 'id_parent' => \$model->" . $generator->getParentColumn() . " ? \$model->" . $generator->getParentColumn() . " : 0") ?>]);
                    ...
                    'view' => function ($url, $model, $key) {
                        $url = Url::current(['view', 'id' => $model->id<?= $generator->ifParent(", 'id_parent' => \$model->" . $generator->getParentColumn() . " ? \$model->" . $generator->getParentColumn() . " : 0") ?>]);
