 ...
 *     'bootstrap' => ['gii'],
 *     'modules' => [
 *         'gii' => ['class' => 'app\modules\admgii\Module'],
 *     ],
 * ]
 * ~~~
 *
...
class Module extends \yii\base\Module implements BootstrapInterface
{
     ...
     * @inheritdoc
     */
    public $controllerNamespace = 'app\modules\admgii\controllers';
    /**
    ...
    public $modulePath = '@app/modules/admgii';


    public function init()
    {
        Yii::setAlias("admgii", $this->modulePath);
        parent::init();
    }
    ...
    public function bootstrap($app)
    {
        if ($app instanceof \yii\web\Application) {
            ...
            $app->controllerMap[$this->id] = [
                'class' => 'app\modules\admgii\console\GenerateController',
    ...
    {
        return [
            'crudmodule' => ['class' => 'app\modules\admgii\generators\crudmodule\Generator'],
            'modelmodule' => ['class' => 'app\modules\admgii\generators\modelmodule\Generator'],
            'model' => ['class' => 'app\modules\admgii\generators\model\Generator'],
            'crud' => ['class' => 'app\modules\admgii\generators\crud\Generator'],
            'controller' => ['class' => 'app\modules\admgii\generators\controller\Generator'],
            'form' => ['class' => 'app\modules\admgii\generators\form\Generator'],
            'module' => ['class' => 'app\modules\admgii\generators\module\Generator'],
            'extension' => ['class' => 'app\modules\admgii\generators\extension\Generator'],
            'table' => ['class' => 'app\modules\admgii\generators\table\Generator'],
        ];
    }
}
